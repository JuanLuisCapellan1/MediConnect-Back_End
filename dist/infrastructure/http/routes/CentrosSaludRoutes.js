...
const autenticacion_1 = require("../middlewares/autenticacion"); // Middleware opcional para aceptar registro tokens
 ...
 */
centrosSaludRouter.post('/completar-perfil', autenticacion_1.autenticarJWTOpcional, // Middleware opcional (no bloqueante)
upload.fields([
