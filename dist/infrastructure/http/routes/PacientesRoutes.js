 ...
 */
router.get('/', autenticacion_1.autenticarJWT, (0, roleMiddleware_1.requireRole)('Admin'), (req, res) => pacienteController.listar(req, res));
/**
 * GET /pacientes/me
 * Obtener perfil del paciente autenticado
 */
router.get('/me', autenticacion_1.autenticarJWT, (0, roleMiddleware_1.requireRole)('Paciente'), (req, res) => pacienteController.obtenerPerfil(req, res));
/**
 * GET /pacientes/:id
 * Obtener paciente por ID (solo Admin)
 */
router.get('/:id', autenticacion_1.autenticarJWT, (0, roleMiddleware_1.requireRole)('Admin'), (req, res) => pacienteController.obtenerPorId(req, res));
/**
 * PATCH /pacientes/me
