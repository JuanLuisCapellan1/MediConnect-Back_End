...
class PrismaSeguroMedicoRepository {
    ...
    mapearSeguroMedico(seguro) {
        ...
        if (seguro.seguros_tipos) {
            tiposPermitidos = seguro.seguros_tipos.map((st) => ({
        ...
        return new SeguroMedico_1.SeguroMedico(seguro.id, seguro.nombre, seguro.estado, seguro.creadoEn, seguro.urlImage, tiposPermitidos);
    }
}
