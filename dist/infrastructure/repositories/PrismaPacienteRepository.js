...
class PrismaPacienteRepository {
    ...
    async actualizar(usuarioId, datos) {
        ...
        if (datos.genero !== undefined)
            dataToUpdate.genero = datos.genero;
        if (datos.altura !== undefined)
            dataToUpdate.altura = datos.altura;
        if (datos.peso !== undefined)
            dataToUpdate.peso = datos.peso;
        if (datos.tipoSangre !== undefined)
            dataToUpdate.tipoSangre = datos.tipoSangre;
        if (datos.ubicacionId !== undefined)
            dataToUpdate.ubicacionId = datos.ubicacionId;
