...
exports.SolicitarCodigoRegistroUseCase = void 0;
const tsyringe_1 = require("tsyringe");
const RedisCacheService_1 = require("../../infrastructure/external-services/RedisCacheService");
let SolicitarCodigoRegistroUseCase = class SolicitarCodigoRegistroUseCase {
    ...
    async execute(email) {
        ...
        await this.emailService.enviarCorreo(email, 'Código de Registro - MediConnect', `Tu código de registro es: ${codigoOTP}. Este código es válido por 15 minutos.`);
    }
};
exports.SolicitarCodigoRegistroUseCase = SolicitarCodigoRegistroUseCase;
exports.SolicitarCodigoRegistroUseCase = SolicitarCodigoRegistroUseCase = __decorate([
...
], SolicitarCodigoRegistroUseCase);
