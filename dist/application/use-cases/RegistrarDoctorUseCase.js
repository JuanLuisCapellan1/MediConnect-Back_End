...
let RegistrarDoctorUseCase = class RegistrarDoctorUseCase {
    constructor(usuarioRepository, especialidadRepository, passwordHasher, storageService, authService, enviarNotifUC) {
            ...
            try {
                ...
                for (const admin of admins) {
                    this.enviarNotifUC.execute({
                        ...
                        tipoEntidad: 'Perfil',
                    }).catch((e) => console.error('notif registrarDoctor admin:', e));
                }
            }
            catch (notifErr) {
...
exports.RegistrarDoctorUseCase = RegistrarDoctorUseCase = __decorate([
    ...
    __param(5, (0, tsyringe_1.inject)(EnviarNotificacionUseCase_1.EnviarNotificacionUseCase)),
