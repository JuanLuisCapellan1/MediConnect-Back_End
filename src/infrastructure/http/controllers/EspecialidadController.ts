...
import { FiltroEspecialidadesDto } from '../../../application/dtos/EspecialidadDtos';

@injectable()
export class EspecialidadController {
    constructor(
        @inject(GestionarEspecialidadesUseCase)
        private useCase: GestionarEspecialidadesUseCase
    ) { }
    ...
    async listar(req: Request, res: Response): Promise<void> {
        try {
            const filtros: FiltroEspecialidadesDto = {
